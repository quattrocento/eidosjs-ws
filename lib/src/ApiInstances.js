...
export default {
    ...
    */
    reset: function ( cs = "ws://dex.eidos.one:8000", connect, connectTimeout = 4000, optionalApis, closeCb ) {
    ...
    instance: function ( cs = "ws://dex.eodis.one:8000", connect, connectTimeout = 4000, optionalApis, closeCb) {
        if ( ! inst ) {
            inst = new ApisInstance();
            inst.setRpcConnectionStatusCallback(this.statusCb);
        }
